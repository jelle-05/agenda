...
- **Reistijd-buffer** — stel per afspraak een reistijd in (presets of een eigen aantal minuten); de app toont "Vertrek om 08:40" in het formulier en een gestreept schaduwblok vóór de afspraak in de dag-/weekweergave. Volledig handmatig — er wordt geen route, locatie of live positie opgehaald
