...
import { X, Cake, Tag, SlidersHorizontal, StickyNote } from 'lucide-react'
...
export default function MobielMenu({ open, onSluit, onFilters, onVerjaardagen, onLabels }: Props) {
  const actieItems: {
    key: string
    label: string
